...
function checkForm2() {
	...
	return false;}
	if (checkEmailRE(document.forms[0].email.value) == false)
	{alert("Invalid email format");
    return false;}
	if (checkPhoneRE(document.forms[0].phone.value) == false)
...
function checkEmailRE(email) {

	regx = /^\w[-._\w]*\w@\w[-._\w]*\w\.\w{2,8}$/;
	return regx.test(email);

}

function checkPhoneRE(phone) {
